...
local function ApplySkin()
    ...
    -- Strip Textures
    local charframe = {
        CharacterFrame, CharacterModelScene, CharacterFrameInset,
        CharacterStatsPane, CharacterFrameInsetRight, PaperDollSidebarTabs
    }
...
-- ============================================================
-- COMBAT-AWARE SKIN APPLICATION
-- ============================================================

-- Try to apply skin when out of combat
local function TryApplySkin()
    if not skinApplied and not InCombatLockdown() then
        ApplySkin()
    end
end

-- Apply skin when leaving combat
...
-- Apply skin when character frame shows (if out of combat)
...
C_Timer.After(0.1, TryApplySkin)
