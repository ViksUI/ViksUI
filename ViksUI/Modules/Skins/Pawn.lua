...
local function LoadSkin()
	...
	PawnUIStringDialog:StripTextures()
	PawnUIValuesTabPage:StripTextures()
	PawnUIFrame_StatsList:StripTextures()
	PawnUIFrame_StatsListScrollChildFrame:Hide()
	PawnUIStringDialog:SetTemplate("Overlay")
	PawnUIFrame_StatsList:SetTemplate("Default")
	T.SkinEditBox(PawnUIStringDialog_TextBox)
	PawnUIStringDialog_OKButton:SkinButton(true)
	PawnUIStringDialog_CancelButton:SkinButton(true)
