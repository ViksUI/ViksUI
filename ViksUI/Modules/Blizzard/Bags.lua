...
function Stuffing:InitBags()
	...
	local filterTable = {
		...
		[7] = {1500871, C_Item.GetItemClassInfo(8)},		-- Item Enhancement
		[8] = {628559, C_Item.GetItemClassInfo(3)},			-- Gem
		[9] = {648841, C_Item.GetItemSubClassInfo(15,4)},	-- Miscellaneous Other
	}
