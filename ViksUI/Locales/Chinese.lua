...
L_MISC_UI_OUTDATED = "ViksUI 版本已过期，请至 http://www.wowinterface.com/downloads/info21462-ViksUI.html#info 下载最新版"
...
L_POPUP_DISABLEUI = "ViksUI不支持此分辨率, 是否停用ViksUI? (若调整其他分辨率,请按取消)"
...
L_WELCOME_LINE_2_1 = "输入/cfg进行插件设置,或者访问http://www.wowinterface.com/downloads/info21462-ViksUI.html#info"
