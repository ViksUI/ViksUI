...
if ViksUIOptionsGlobal then
	if ViksUIOptionsGlobal[T.realm] and ViksUIOptionsGlobal[T.realm][T.name] and ViksUIOptionsGlobal[T.realm]["Current_Profile"] then
		...
		if ViksUIOptionsPerChar and ViksUIOptionsPerChar[i] and ViksUIOptionsPerChar[i]["font"] and ViksUIOptionsPerChar[i]["font"]["global_font"] then
			disablePixel = true
		end
	else
		local i = tostring(ViksUIOptionsGlobal["Current_Profile"])
		if ViksUIOptions and ViksUIOptions[i] and ViksUIOptions[i]["font"] and ViksUIOptions[i]["font"]["global_font"] then
			disablePixel = true
		end
	end
end
