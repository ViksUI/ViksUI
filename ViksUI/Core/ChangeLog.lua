...
local ChangeLogData = {
	...
	"• Major Unitframe Improvements",
	"• Layout 2 added player and target frames, old style",
	"• Layout 2, change tags from pre made, or create your own.",
	"• Created TagValidator, to check user created tags. /vtags",
	"• Blizzard Integration of some Aura functions. Filger partly working",
	"• Some other fixes like volum datatext, Micromenu etc",
	"• Info Stats updated",
	"• Still out traveling. Happy leveling everyone",
	"• check: https://github.com/ViksUI/ViksUI/releases/tag/12.0.3",
" ",
