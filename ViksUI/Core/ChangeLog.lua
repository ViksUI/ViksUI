...
local ChangeLogData = {
	"Changes:",
		"Update 8.93",
		"• Party & Raid not turning off fix",
		"• Filger spells updated",
		"• More item's to OpenItems", 
		"• Moved bnet popup for line layout", 
		"• Bags code tweaked", 
		"• Copy Chat updated and Editbox moved for line layout",
		"• RadiCD code updated",
		"• Battleground info updated",
		"• New currency added",
		"• Some old stuff removed",
		"• Some globals/variables changed",
		"• Few skins updated and tweaked",
		--"• ",
	--" ",
	...
	"NOTE:",
		...
		"8 years with hundreds of hours on coding, ",
