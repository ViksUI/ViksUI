...
local ChangeLogData = {
	"Changes:",
	"Update 11.40 ",
	"• [SlotItem] Code improved/error fixed.",
	"• [Aurawatch] Added option to show timer",
	"• [ProfessionTabs] Showing tab for Herb/Mining/Fishing Journal. ",
	...
	"• check: https://github.com/ViksUI/ViksUI/releases/tag/11.1.37",
" ",
"EXTRA:",
