...
local ChangeLogData = {
	...
	"• Infopanels / Stats updated and improved code",
	"• Auto Accept - Ignoring few quest at weekly quest givers",
	"• Objective Tracker - Find group button always show on inside of screen",
	"• Bags - Warband and Bank updated",
	"• Filger - Added S3 trinkets to Buff bar",
	"• Nameplates - Added ignore Debuff option. Right click on Add spell in config",
	"• check: https://github.com/ViksUI/ViksUI/releases/tag/11.1.45",
	"Update 11.44 ",
