...
L.profile_export = "导出"
L.profile_import = "导入"
L.profile_error_lib = "要启用导入和导出，请安装Media_ViksUI"
...
L.quest_quest_auto_button = "任务/道具自动按钮"
L.quest_quest_auto_button_desc = "任务/道具自动按钮"
L.quest_accept_quest = "自动交接任务(按住Shift临时停用)"
