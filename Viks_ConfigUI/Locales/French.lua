...
L.profile_error_lib = "Pour activer l'exportation et l'importation - installer Media_ViksUI"
...
L.quest_quest_auto_button = "Bouton automatique des objets de quête"
L.quest_quest_auto_button_desc = "Affiche un bouton pour les objets de quête au-dessus de la minimap (de la liste)"
L.quest_accept_quest = "Accepter les quêtes automatiquement (désactivée si vous maintenez Shift)"
