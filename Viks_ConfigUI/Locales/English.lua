...
L.profile_error_lib = "To enable export and import - install Media_ViksUI"
...
L.unitframe_enemy_health_color_desc = "Color an enemy player's health bar red"
...
L.aura_player_buff_mouseover = "Show Buff Frame on MouseOver"
...
L.automation_summon_desc = "Summon from players"
L.automation_minimap_zoom = "?hange minimap zoom level when moving"
...
L_GUI_UF_AUTOHODE = "Always Hide Raidframes if Vuhdo/Healbot/Grid is loaded"
L_GUI_UF_SHOW_FOCUST = "Target of focus"
L_GUI_UF_SHOW_TANKS = "Main tanks"
L.unitframe_tankdebuff = "Size of debuff on tankframes"
L_GUI_UF_PORTRAIT_BARS = "Show portraits on Healthbar (Disable above)"
...
L.unitframe_Portrait_w = "Width of Portrait frame"
L.unitframe_Portrait_h = "Height of Portrait frame"
L.unitframe_Player_w = "Width of Player frame"
L.unitframe_Player_h = "Height of Player frame"
L.unitframe_Target_w = "Width of Target frame"
L.unitframe_Target_h = "Height of Target frame"
L.unitframe_Targettarget_w = "Width of ToT frame"
L.unitframe_Targettarget_h = "Height of ToT frame"
L.unitframe_Focus_w = "Width of Focus frame"
L.unitframe_Focus_h = "Height of Focus frame"
L.unitframe_Focustarget_w = "Width of Focus Target frame"
L.unitframe_Focustarget_h = "Height of Focus Target frame"
L.unitframe_Pet_w = "Width of Pet frame"
L.unitframe_Pet_h = "Height of Pet frame"
L.unitframe_PetTarget_w = "Width of Pet Target frame"
L.unitframe_PetTarget_h = "Height of Pet Target frame"
L.unitframe_Boss_w = "Width of Boss frame"
L.unitframe_Boss_h = "Height of Boss frame"
L.unitframe_Tank_w = "Width of Tank frame"
L.unitframe_Tank_h = "Height of Tank frame"
L.unitframe_TankH_w = "HF: Width of Tank frame"
L.unitframe_TankH_h = "HF: Height of Tank frame"
L.unitframe_Raid10H_w = "Width of Raid 10 man frame"
L.unitframe_Raid10H_h = "Height of Raid 10 man frame"
L.unitframe_Raid25H_w = "HF: Width of Raid 25 man frame"
L.unitframe_Raid25H_h = "HF: Height of Raid 25 man frame"
L.unitframe_Raid25_w = "Width of Raid 25 man frame"
L.unitframe_Raid25_h = "Height of Raid 25 man frame"
L.unitframe_Raid40H_w = "HF: Width of Raid 40 man frame"
L.unitframe_Raid40H_h = "HF: Height of Raid 40 man frame"
L.unitframe_Raid40_w = "Width of Raid 40 man frame"
L.unitframe_Raid40_h = "Height of Raid 40 man frame"
L.unitframe_Party_w = "Width of Party frame"
L.unitframe_Party_h = "Height of Party frame"
L.unitframe_Arena_w = "Width of Arena frame"
L.unitframe_Arena_h = "Height of Arena frame"
L.unitframe_CastbarPlayer_w = "Castbar Width: Player"
L.unitframe_CastbarPlayer_h = "Castbar Height: Player"
L.unitframe_CastbarTarget_w = "Castbar Width: Target"
L.unitframe_CastbarTarget_h = "Castbar Height: Target"
L.unitframe_CastbarArena_w = "Castbar Width: Arena"
L.unitframe_CastbarArena_h = "Castbar Height: Arena"
L.unitframe_CastbarBoss_w = "Castbar Width: Boss"
L.unitframe_CastbarBoss_h = "Castbar Height: Boss"
L.unitframe_CastbarFocus_w = "Castbar Width: Focus"
L.unitframe_CastbarFocus_h = "Castbar Height: Focus"
...
L.tooltip_npc_id = "NPC ID Number"
L.chat_reset_pos = "Automatically position chat windows"
L.chat_smileys = "Insert smileys instead of symbols like xD"
L_GUI_NAMEPLATE_DISTANCE = "Display range"
L.nameplate_npc_colors = "Show different colored icon for priority targets"
L_GUI_NAMEPLATE_PRIORITY_COLOR = "Color for High priority Targets"
L_GUI_NAMEPLATE_SEMIPRI_COLOR = "Color for Semi priority Targets"
L_GUI_NAMEPLATE_NUKE_COLOR = "Color for Nuke targets"
L_GUI_NAMEPLATE_T3MOBS_COLOR = "T3 Mobs/Miniboss/Hard Hitting"
L_GUI_NAMEPLATE_TIDES_COLOR = "Void Touched Mobs (affix)"
L_GUI_NAMEPLATE_PVPSTUFF_COLOR = "Pvp stuff"	
L_GUI_NAMEPLATE_EXPLOSIVE_COLOR = "Explosive Color"
L_GUI_NAMEPLATE_TARGETARROW_COLOR = "Color for target Arrow"
L_GUI_NAMEPLATE_TARGETGLOW_COLOR = "Color for target glow"
...
L.panels_HideDetailsPanels = "Details: Hides All backgrounds"
L.panels_twoDetailsPanels = "Details: Only show 1 panel on right side"
L.misc_markbar = "Markbar for Raid Icons and flares"
L.misc_classtimer = "[ClassTimer] Shows buff/debuffs/procs as bar on player/target frame"
L.misc_BT4Bars = "Panels behind Sidebar & Small bars for Bartender 4"
L.misc_Pscale = "Scale ViksUI Panels"
L.misc_panelsh = "Set UI Panels to hidden"
L.misc_InfoPanel_Stats = "Show Wowhead Stats Priorities"
L.misc_InfoPanel_Stats_desc = "Will show stats panel above character panel with default stats from Wowhead. Usefull when leveling"
L.misc_XPBar = "Enable XP/REP/HONOR Bars above chat windows"
L.misc_meters = "Skada/Details Toggle & Chat Move for NoPanel"
L.misc_meters_desc = "For double chat and NoPanel Layout. Will swap bethween Chat and Dmg meters on right side"
L.misc_meters_show = "Hide Chat on startup"
L.misc_meters_show_desc = "Enabled will hide chat, disabled will hide details as default on enter world"
--Extra		
...
L.datatext_Arena = "Arena Score"
L.datatext_Armor = "Armor Value"
L.datatext_RunSpeed = "Run Speed"
L.datatext_Avd = "Avoidance"
L.datatext_Bags = "Bag Space"
L.datatext_Battleground = "Enable 3 stats in battleground only that replace stat1,stat2,stat3"
L.datatext_Crit = "Crit"
L.datatext_Durability = "Durability"
L.datatext_Friends = "Friends List"
L.datatext_Gold = "Gold"
L.datatext_Guild = "Guild"
L.datatext_Haste = "Haste"
L.datatext_Versatility = "Versatility"
L.datatext_location = "Location"
L.datatext_showcoords = "Coordinates on location"
L.datatext_Mastery = "Mastery"
L.datatext_Power = "Power"
L.datatext_Regen = "Mana regeneration"
L.datatext_System = "Fps and MS"
L.datatext_Talents = "Talent"
L.datatext_togglemenu = "Minimenu"
L.datatext_Volume = "Volume"
L.datatext_Wowtime = "THIS IS BLOCKED TO FIXED POSITION! SO CAN'T BE CHANGED HERE! NUMBER MUST BE > 0, BUT DOESN'T USE UP A SPOT!"
L.datatext_Time24 = "Set time to 24h format"
L.datatext_Localtime = "Show Local time instead of server time"
L.datatext_classcolor = "Use Class Color in text"
L.datatext_color = "Color to use it not Class color"
L_GUI_DATATEXT_SUBHEADER_CURRENCY = "Options"
L.datatext_CurrArchaeology = "Archaeology Fragments under gold"
L.datatext_CurrCooking = "Cooking Awards under gold"
L.datatext_CurrProfessions = "Profession Tokens under gold"
L.datatext_CurrMiscellaneous = "Miscellaneous Currency under gold"
L.datatext_CurrPvP = "PVP Currency under gold"
L.datatext_CurrRaid = "Raid Seals under gold"
L.datatext_Quests = "Quest position"
...
L.automation_AutoRepair = "Auto Repair at vendor"
L.automation_AutoRepairG = "Auto Repair at vendor, GuildFund"
-- Quest options
L.quest = "Quest"
L.quest_subtext = "In this page you can customize things related to quest"
L.quest_auto_collapse = "Auto collapse Objective Tracker"
L.quest_auto_collapse_desc = "Cause UseQuestLogSpecialItem() taint"
L.quest_quest_auto_button = "Quest items auto button"
L.quest_quest_auto_button_desc = "The button for quest items above the minimap (from the list)"
L.quest_accept_quest = "Auto accept quest (disabled if hold Shift)"
L.quest_header_left = "Show quest frame on left side"
L.quest_header_button_only = "Show only +/- button and not text"
L.quest_header_text_color = "Color for headers"
L.quest_header_text_font = "Font for headers"
L.quest_header_text_ori = "Justify text for headers"
L.quest_header_text_font_size = "Header font size"
L.quest_header_text_font_style = "Font Style for headers"
L.quest_subheader = "Objective Tracker"
L.quest_subheader_header = "Headers"
L.quest_subheader_title = "Quest titles"
L.quest_subheader_bar = "Line under headers"
L.quest_title_text_color = "Color for Titles"
L.quest_title_text_font = "Font for Titles"
L.quest_title_text_font_size = "Title font size"
L.quest_title_text_font_style = "Font Style for title"
L.quest_header_bar_Texture = "Texture for line under headers"
L.quest_header_bar_color = "Color for line under headers"
L.quest_header_bar_height = "Height for line under headers"
L.quest_header_bar_width = "Width for line under headers"

-- ====================================================================
-- LAYOUT2 CONFIGURATION LOCALIZATION
-- ====================================================================
-- Note for me: Need Review and remove not needed later

L.layout2_title = "Layout2 Unit Frames" -- Need Review
L.layout2_explain = "Only show what is overwriting default unitframe" -- Need Review
L.layout2_enable = "Enable Layout2 modifications" -- Need Review
...
L.layout2_section_debuffs = "Debuff size if Big Debuff enabled" -- Need Review
L.layout2_player_bigdebuff = "Use Big Debuff frame" -- Need Review
