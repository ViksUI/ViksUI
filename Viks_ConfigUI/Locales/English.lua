...
L.misc_InfoPanel_Stats = "Show Icy Veins Stats Priorities"
L.misc_InfoPanel_Stats_desc = "Will show stats panel above character panel with default stats from Icy Veins. Usefull when leveling"
