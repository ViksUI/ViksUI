...
ns.addCategory("misc", OTHER, L.misc_subtext, 2)
...
do
	...
	subheader2:SetPoint("TOPLEFT", explosive_color or offtank_color, "BOTTOMLEFT", 0, -10)
	...
	mob_color_enable:SetPoint("TOPLEFT", targetglow_color, "BOTTOMLEFT", -24, -8)
...
local function PositionGameMenuButton()
	...
	for button in GameMenuFrame.buttonPool:EnumerateActive() do
		GameMenuFrame.ViksUI:SetPoint("TOPLEFT", GameMenuFrame, "TOPLEFT", 28, -30)
...
-- Expose the ConfigUI namespace so that optional add-ons (e.g. ViksUI_Profile)
-- can register additional categories via ViksConfigUI_ns.addCategory() after all
-- default categories have already been added (and the offset is correct).
ViksConfigUI_ns = ns