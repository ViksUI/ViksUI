...
L_GUI_RESET_CHAR = "Вы уверены, что хотите сбросить все настройки VikskUI для этого персонажа?"
L_GUI_RESET_ALL = "Вы уверены, что хотите сбросить все настройки VikskUI?"
